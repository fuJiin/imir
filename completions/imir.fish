...
complete -c imir -n "not __fish_seen_subcommand_from init uninstall upgrade create bake connect ssh tunnel ip sessions kill-session list rename destroy help" \
    -a "init uninstall upgrade create bake connect ssh tunnel ip sessions kill-session list rename destroy help"
